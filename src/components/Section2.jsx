...
const Section2 = () => {
  return (
    <div id="aboutSection">
      <div className="relative flex font-work-sans items-stretch bg-red-white py-16">
      <div className="grid grid-cols-1 md:grid-cols-5 grid-rows-5 gap-4 w-full">
          <div className="col-span-3 row-span-5 col-start-2 row-start-1">
            ...
            <p className="p-6 font-normal text-slate-600 text-2xl">
            ...
            <div className="relative font-work-sans px-6">
          ...
          <div className="row-span-5 col-start-1 row-start-1"></div>
          <div className="row-span-5 col-start-5"></div>
        </div>
      </div>
    </div>
  );
