  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div
          className="bg-zinc-950 text-white px-6 py-4 flex justify-between items-center"
          style={HEADER_STYLE}
        >
